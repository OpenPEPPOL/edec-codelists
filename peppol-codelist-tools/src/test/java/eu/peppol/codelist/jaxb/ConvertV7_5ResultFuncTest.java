 ...
 */
public final class ConvertV7_5ResultFuncTest
{
  @Test
  public void testReadDocTypes ()
  {
    final DocumentTypeCodeListMarshaller m = new DocumentTypeCodeListMarshaller ();
    final File f = new File (ConvertV7_5.DESTINATION_BASE_PATH,
                             DocTypeRow.CODE_LIST_NAME + ConvertV7_5.DESTINATION_FILENAME_SUFFIX + ".xml");
    assertTrue (f.exists ());
  ...
  public void testReadParticipantIdentifierSchemes ()
  {
    ...
    final File f = new File (ConvertV7_5.DESTINATION_BASE_PATH,
                             ParticipantIdentifierSchemeRow.CODE_LIST_NAME + ConvertV7_5.DESTINATION_FILENAME_SUFFIX + ".xml");
    assertTrue (f.exists ());
  ...
  public void testReadProcesses ()
  {
    ...
    final File f = new File (ConvertV7_5.DESTINATION_BASE_PATH,
                             ProcessRow.CODE_LIST_NAME + ConvertV7_5.DESTINATION_FILENAME_SUFFIX + ".xml");
    assertTrue (f.exists ());
  ...
  public void testReadTransportProfiles ()
  {
    ...
    final File f = new File (ConvertV7_5.DESTINATION_BASE_PATH,
                             TransportProfileRow.CODE_LIST_NAME + ConvertV7_5.DESTINATION_FILENAME_SUFFIX + ".xml");
    assertTrue (f.exists ());
