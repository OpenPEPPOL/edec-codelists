 ...
 */
public final class MainProcessExcel_v8_3_1
{
  private static final Logger LOGGER = LoggerFactory.getLogger (MainProcessExcel_v8_3_1.class);

  public static void main (final String [] args) throws Exception
  {
    new ConvertV8_3_1 ().run ();
